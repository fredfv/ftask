...
void main() {
  ...
  test('should return a error showing what is wrong in the field when not pass a value', () {
    expect(createAccountRequest.name.validate(), 'fill the field to submit');
  });
  ...
  test('should return a error showing what is wrong in the field when pass a value but only one word', () {
    ...
    expect(createAccountRequest.name.validate(), 'fill it with full name');
  });

  test('should return null when pass a value with two words', () {
    createAccountRequest.setName('test test');
    expect(createAccountRequest.name.validate(), null);
  });

  test('should return a error showing what is wrong in the field when not pass a value', () {
    expect(createAccountRequest.login.validate(), 'fill the field to submit');
  });

  test('should return null when pass a value with one word', () {
    createAccountRequest.setLogin('test');
    expect(createAccountRequest.login.validate(), null);
  });

  test('should return a error showing what is wrong in the field when not pass a value', () {
    expect(createAccountRequest.secret.validate(), 'fill the field to submit');
  });

  test('should return null when pass a value with one word', () {
    createAccountRequest.setSecret('test');
    expect(createAccountRequest.secret.validate(), null);
  });

  test('should return a error showing what is wrong in the field when not pass a value', () {
    expect(createAccountRequest.secretConfirm.validate(), 'fill the field to submit');
  });

  test('should return null when pass a value with one word', () {
    createAccountRequest.setSecretConfirm('test');
    expect(createAccountRequest.secretConfirm.validate(), null);
  });
